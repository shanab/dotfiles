...
for _, nav in pairs(navchars) do
	vim.api.nvim_set_keymap("n", "<C-" .. nav .. ">", "<C-W>" .. nav, {
		silent = true,
		noremap = true,
	})
end
...
-- Fzf shortcuts
vim.api.nvim_set_keymap("n", "<leader><leader>", ":Files<cr>", {
	silent = true,
	noremap = true,
})
...
local on_attach = function(_, bufnr)
	...
	vim.api.nvim_buf_set_keymap(bufnr, "n", "<leader>ll", "<cmd>lua vim.lsp.diagnostic.set_loclist()<CR>", opts)
...
nvim_lsp["gopls"].setup({
	...
	root_dir = function(fname)
		return nvim_lsp.util.root_pattern("go.mod", ".git")(fname) or vim.loop.cwd()
	end,
	settings = {
		gopls = {
			analyses = {
