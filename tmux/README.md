...
These are the most important tmux shortcuts you should memorize:

### Session & Window Management

- `Prefix + d` - Detach from session
- `Prefix + $` - Rename session
- `Prefix + C-c` - Create new window (in home directory)
- `Prefix + r` - Rename current window
- `Prefix + &` - Kill current window
- `Prefix + n` / `Prefix + L` - Next window
- `Prefix + p` / `Prefix + H` - Previous window
- `Prefix + a` / `Prefix + C-a` - Last window
- `Prefix + 0-9` - Switch to window by number

### Pane Management

- `Prefix + s` - Split window vertically (horizontal pane)
- `Prefix + v` - Split window horizontally (vertical pane)
...
- `Prefix + ,/-/.` - Resize pane left/down/right (20/7/20 units)
- `Prefix + =` - Resize pane up (7 units)
- `Prefix + M-Up/Down/Left/Right` - Fine resize (5 units)
...
- `V` - Select line (in copy mode, vi-style)

### Plugin & Utility Shortcuts

- `Prefix + F` - Fuzzy finder (tmux-fzf)
- `Prefix + Space` - Thumbs mode (link hints)
- `Prefix + u` - URL picker
